...
out_dir = \
    'E:\\DHWorkStation\\Project\\tgs_pytorch\\output\\resnet34'

initial_checkpoint = \
    'E:\\DHWorkStation\\Project\\tgs_pytorch\\output\\resnet34\\checkpoint\\48150_model.pth'
...
def run_local_leaderboard(augment):
    ...
    ##--------------
    ### Threshold Optimizer
    threshes = np.arange(0.15, 0.85, 0.05)
    for thres in threshes:
        precision, result, threshold = do_kaggle_metric(predict, truth, threshold=thres)
