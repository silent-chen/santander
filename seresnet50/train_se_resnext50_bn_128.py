...
BRANCH_PATH = 'seresnext50_bn\\fold1\\'
...
def run_train():
    ...
    initial_checkpoint = \
    'E:\\DHWorkStation\\Project\\tgs_pytorch\\output\\seresnext50_bn\\fold1\\checkpoint\\00062200_iou_0.880_model.pth'
    ...
    batch_size = 18
    train_dataset = TsgDataset('train_3600_1_origin', train_augment, 'train')
    ...
    valid_dataset = TsgDataset('valid_400_1_origin', valid_augment, 'train')
    ...
    iter_save = [0, num_iters - 1] \
                +list(range(0,num_iters-1,20*200))
    ...
    schduler = StepScheduler(
        [(0, 0.01),(62200,0.002)])  # None  #LR = StepLR([ (0, 0.01),  (200, 0.001),  (300, -1)])
    ...
    i = 0
    val_loss_min = 0.245
    swa_val_loss_min = 0.245
    val_iou_max =0.878
    swa_val_iou_max = 0.878
    start = timer()
